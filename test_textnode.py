...
class TestTextNode(unittest.TestCase):
    ...
    def test_create_text_node(self):
        ...
        self.assertEqual(node.content, "This is a text node")
    ...
    def test_text_to_textnodes(self):
        ...
        nodes = text_to_textnodes("This is a test")
        expected = [
    ...
    def test_no_links_in_text(self):
        ...
        result = text_to_textnodes(node.content)
        expected = [TextNode("This is plain text with no links.", text_type_text)]
    ...
    def test_no_images_in_text(self):
        ...
        result = text_to_textnodes(node.content)
        expected = [TextNode("This is plain text with no images.", text_type_text)]
        self.assertEqual(result, expected)
